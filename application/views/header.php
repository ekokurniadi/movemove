...
<head>
  ...
  <link rel="stylesheet" href="https://www.sinarsentosaprimatama.com/assets/toastr/toastr.css">
  <script src="https://www.sinarsentosaprimatama.com/assets/toastr/toastr.min.js"></script>
  ...
  <div id="app">
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <div style="color:white;font-weight:bold;">Anda Mempunyai <span class="jml_notif"></span> Notifikasi Baru
              </div>
          ...
          <i class="far fa-bell"></i>
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-footer text-center">
                <a href="<?php echo base_url('driver')?>">View All <i class="fas fa-chevron-right"></i></a>
              </div>
            </div>
          </li>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <img src="<?= base_url()?>image/ic_launcher.png" alt="" width="60px">
          </div>
          </div>
          ...
          <?php if($_SESSION['role']=="Admin"){?>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="<?php echo base_url('driver')?>">Driver</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('orders')?>">Orders</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('top_up')?>">Top Up</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('setting_potongan')?>">Setting Potongan</a></li>
                </ul>
