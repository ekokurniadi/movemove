      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label" for="double"></label>
                <div class="col-sm-12">
                <a type="button" class="btn btn-primary" style="color:white;" onclick="sum();"> Hitung <i class="fa fa-calculator"></i></a> 
                </div>
              </div>
