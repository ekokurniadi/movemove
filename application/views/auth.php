      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="login-brand">
            <!-- <img src="image/logo_hond.png" alt="logo" width="100"  style="margin-top:-35px"> -->
            </div>
            <h3 style="color:white;">Login</h3>
            <!-- <p style="color:red;">Unit Entry AHASS Jambi</p> -->
            </div>
            ...
            <!-- <img src="<?php echo base_url().'image/logo_ig.png'?>" alt="" width="18px" > Follow Instagram :
            <a href="https://www.instagram.com/hondajambi/?hl=id" target="_blank" >hondajambi</a>  -->
            </div>
              </div>
            </div>
